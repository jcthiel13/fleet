...
function SpawnVehicle(hash, coords, isnetworked)
    local model = hash
...
function CheckPerms(player)
    local fwplayer = exports.framework:getclientdept(player)
    --TriggerEvent('table', fwplayer)
    print('Admin status is ' .. tostring(fwplayer[player].admin))
    return fwplayer[player].admin
end

--todo: Configure this function
function DoDamage(currentVehicle, damage)
    --TriggerEvent('table', damage)
    print(damage.engine)
    local engine = damage.engine + 0.0
    local body = damage.body + 0.0
